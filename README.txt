...
**Use the app here**: [Streamlit Live App](https://diabetes-predictorr.streamlit.app/)
...
- **Feature Importance Plot**  
  Highlights the most influential features (Glucose and BMI are the strongest).

- **Confusion Matrix**  
  Shows model accuracy in predicting diabetic vs non-diabetic cases.
...
```bash
# Clone the repo
https://github.com/mhamed-majdob/diabetes-prediction-app.git
